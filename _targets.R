...
targets <- list(
  ...
  # Use R/prepare_template.R to create new preparation_scripts
   ...
   tar_target(df_AIM, prepare_AIM(DF_clean, short_name_scale_str = 'AIM', output_formats = output_formats)),
   tar_target(df_Consent, prepare_Consent(DF_clean, short_name_scale_str = 'Consent', output_formats = output_formats)),
   tar_target(df_DASS21, prepare_DASS21(DF_clean, short_name_scale_str = 'DASS21', output_formats = output_formats)),
